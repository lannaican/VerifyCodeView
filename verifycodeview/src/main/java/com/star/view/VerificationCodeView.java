...
public class VerificationCodeView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEtNumber = typedArray.getInteger(R.styleable.VerificationCodeView_vcv_count, 1);
    ...
    // 初始UI
    private void initUI() {
        initTextViews(getContext(), mEtNumber, mEtDividerDrawable, mEtTextSize, mEtTextColor);
    ...
    //初始化TextView
    private void initTextViews(Context context, int etNumber, Drawable etDividerDrawable, float etTextSize, int etTextColor) {
        // 设置 editText 的输入长度
